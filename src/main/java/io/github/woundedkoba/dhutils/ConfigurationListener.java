...
public interface ConfigurationListener {
    /**
     * Validate and possibly modify or veto a potential change to this
     * configuration.
     * <p>
     ...
     * @return the new configuration value, possibly different from
     * {@code newVal}
     * @throws DHUtilsException to prevent the change from occurring
     */
    Object onConfigurationValidate(ConfigurationManager configurationManager,
     ...
     */
    void onConfigurationChanged(ConfigurationManager configurationManager,
                                String key, Object oldVal, Object newVal);
}
